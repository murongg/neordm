...
use crate::commands::{
    ...
    get_redis_db_size, get_redis_key_summary, get_redis_key_type, get_redis_key_value,
    get_redis_key_value_page, get_redis_overview_metrics, get_redis_slowlog,
    get_redis_stream_consumers, get_redis_stream_entries, get_redis_stream_groups,
    get_redis_stream_pending_entries, greet, list_redis_key_names_fast, list_redis_keys,
    proxy_http_request, publish_redis_pubsub_message, rename_redis_key, rename_redis_keys,
    run_redis_command, run_redis_lua_script, scan_redis_keys_page, start_redis_pubsub_session,
    stop_redis_pubsub_session, subscribe_redis_pubsub_channels, subscribe_redis_pubsub_patterns,
    test_redis_connection, unsubscribe_redis_pubsub_channels,
...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            proxy_http_request,
            get_redis_db_size,
            list_redis_key_names_fast,
            list_redis_keys,
            scan_redis_keys_page,
            get_redis_cluster_topology,
            get_redis_key_summary,
            get_redis_key_type,
            get_redis_key_value,
